...
export default function Details() {
  ...
  const message = `Olá ${incident.nome} de ${incident.city}/${incident.uf}, estou entrando em contato pois gostaria de ajudar no caso "${incident.title}" com o valor de R$ ${incident.value}`
